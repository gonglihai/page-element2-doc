...
| 属性名      | 说明                                                         | 类型              | 默认值                  | 可选值                                                       |
| ----------- | ------------------------------------------------------------ | ----------------- | ----------------------- | ------------------------------------------------------------ |
| type        | 查询条件的类型                                               | string            | `'input'`               | <div style="width: 155px">`'input'` 输入框<br/>`'select'` [下拉框](#select-下拉框-属性)<br/>`'date'` [日期](#date-日期-属性)<br/>`'date-range'` [日期范围](#date-range-日期范围-属性)<br/>`'year'` [年](#year-年-属性)<br/>`'year-month'` [年月](#year-month-年月-属性)</div> |
| label       | 查询条件的标题                                               | string            | -                       | -                                                            |
| field       | 查询条件对象的键名                                           | string            | -                       | -                                                            |
| placeholder | 输入提示。<br/>默认的输入提示有两种，分别是：`请输入xxx` 和 `请选择xxx`，其中 `xxx` 为 `label` 配置的值。组件会根据 `type` 自动匹配合适的默认提示。 | string            | `请输入xxx` `请选择xxx` | -                                                            |
...
| ----------------- | ------------------------------------------------------------ | ------- | ------------------------------------------------------ | ---------------------------------------- |
| option            | 静态选项数组                                                 | array   | -                                                      | -                                        |
| api               | 动态选项 api 请求接口 uri 地址, 见 [api 说明](#select-下拉框-属性-api-说明) | string  | -                                                      | -                                        |
| props             | 选项数组内对象的值与显示内容的键名映射关系, 见 [props 说明](#select-下拉框-属性-props-说明) | object  | `{ label: 'name', value: 'id', children: 'chidlren' }` | -                                        |
...
| 属性名      | 说明                                                         | 类型           | 默认值         | 可选值 |
| ----------- | ------------------------------------------------------------ | -------------- | -------------- | ------ |
| field       | 查询条件对象的键名, 这里支持数组, 见 [field 说明](#date-range-日期范围-属性-field-说明) | string / array | -              | -      |
